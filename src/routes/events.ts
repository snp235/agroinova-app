...
// ---- Sugestões de Evento ----
// IMPORTANTE: estas rotas precisam vir ANTES das rotas com /:id, senão
// `/suggestions` cairia em `/:id` e responderia "Evento não encontrado".

// GET /api/events/suggestions  (alias de /suggestions/list para evitar 404 enganoso)
// GET /api/events/suggestions/list
router.get(['/suggestions', '/suggestions/list'], async (req: AuthRequest, res: Response) => {
